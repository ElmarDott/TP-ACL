...
--- RESOURCE
INSERT INTO RESOURCES (RESOURCE, TEMPLATE, DELETEABLE) VALUES ('Document', 'default', false);
INSERT INTO RESOURCES (RESOURCE, TEMPLATE, DELETEABLE) VALUES ('Article', 'default', false);
INSERT INTO RESOURCES (RESOURCE, TEMPLATE, DELETEABLE) VALUES ('Article', 'delete', true);
INSERT INTO RESOURCES (RESOURCE, TEMPLATE, DELETEABLE) VALUES ('Article', 'teaser', true);
INSERT INTO RESOURCES (RESOURCE, TEMPLATE, DELETEABLE) VALUES ('Sample', 'update', true);
...
-- ACCOUNT
INSERT INTO ACCOUNT (EMAIL, PASSWORD, ROLE_NAME, REGISTERED, VERIFIED, DEACTIVATED, VERIFICATION_CODE)
    VALUES ('guest@sample.org', '', 'Guest', '1984-04-01 12:00:01.0', '2020-12-31 12:00:01.0', '2021-01-11 12:00:01.0', '03a057d0-6ee7-43b1-ac68-d9a7681165a4');
INSERT INTO ACCOUNT (EMAIL, PASSWORD, ROLE_NAME, REGISTERED, VERIFIED, DEACTIVATED, VERIFICATION_CODE)
    VALUES ('user@sample.org', '', 'User',   '1984-04-01 12:00:01.0', '2020-12-31 12:00:01.0', null, 'a674b42e-6670-4674-a8c7-8e86132eaaa2');
INSERT INTO ACCOUNT (EMAIL, PASSWORD, ROLE_NAME, REGISTERED, VERIFIED, DEACTIVATED, VERIFICATION_CODE)
    VALUES ('moderator@sample.org', '', 'Moderator', '1984-04-01 12:00:01.0', '2020-12-31 12:00:01.0', null, '3644b892-1438-45e4-87c5-0ea140fea92b');

INSERT INTO ACCOUNT (EMAIL, PASSWORD, ROLE_NAME, REGISTERED, VERIFIED, DEACTIVATED, VERIFICATION_CODE)
    VALUES ('moderator_01@sample.org', '', 'Moderator', '1984-04-01 12:00:01.0', null, '2021-01-11 12:00:01.0', '46b25a22-69b6-43eb-a711-1dcf1ed0eb5e');
INSERT INTO ACCOUNT (EMAIL, PASSWORD, ROLE_NAME, REGISTERED, VERIFIED, DEACTIVATED, VERIFICATION_CODE)
    VALUES ('moderator_02@sample.org', '', 'Moderator', '1984-04-01 12:00:01.0', '2020-12-31 12:00:01.0', null, 'fda79c72-59de-430d-8d5f-8451c7a00c04');
INSERT INTO ACCOUNT (EMAIL, PASSWORD, ROLE_NAME, REGISTERED, VERIFIED, DEACTIVATED, VERIFICATION_CODE)
    VALUES ('admin@sample.org', '', 'Administrator', '1984-04-01 12:00:01.0', '2020-12-31 12:00:01.0', '2021-01-11 12:00:01.0', '2b421f4c-4408-4f99-b1aa-25002b85ea87');

--- #### LOGIN
INSERT INTO LOGIN (IDX, EMAIL, LOGIN, IPADRESS, BROWSER_ID, OPERATION_SYSTEM, LOGOUT)
