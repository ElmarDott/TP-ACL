...
INSERT INTO RESOURCES (RESOURCE, TEMPLATE, ACTIONS, DELETEABLE) VALUES ('Sample', 'update', 'ALL', true);
...
--- #### LOGIN
INSERT INTO LOGIN (IDX, EMAIL, LOGIN_DATE, IPADRESS, BROWSER_ID, OPERATION_SYSTEM, LOGOUT)
    VALUES ('03a057d0-6ee7-43b1-ac68-d9a7681165a4', 'moderator@sample.org', '2010-06-15 12:00:01.0', '127.0.0.1', '', '', false);
INSERT INTO LOGIN (IDX, EMAIL, LOGIN_DATE, IPADRESS, BROWSER_ID, OPERATION_SYSTEM, LOGOUT)
    VALUES ('a674b42e-6670-4674-a8c7-8e86132eaaa2', 'moderator@sample.org', '2010-06-17 12:00:01.0', 'localhost', '', '', false);
INSERT INTO LOGIN (IDX, EMAIL, LOGIN_DATE, IPADRESS, BROWSER_ID, OPERATION_SYSTEM, LOGOUT)
    VALUES ('2b421f4c-4408-4f99-b1aa-25002b85ea87', 'moderator@sample.org', '2010-06-25 12:00:01.0', '127.0.0.1', '', '', false);
